...
class CustomUNetSpatioTemporalConditionModel(
    ...
    def __init__(
        ...
        print("amani-dbg: ", down_block_types)
    ...
    def forward(
        ...
        extracted_features = sample.clone()
        print("amani-dbg: ", extracted_features.shape)
        ...
        if not return_dict:
            return (sample, extracted_features)

        return UNetSpatioTemporalConditionOutput(sample=sample), extracted_features
